...
public class FoodEffectsConfig {
    ...
    public FoodEffectsConfig(ForgeConfigSpec.Builder builder) {
        ...
        MUSHROOM_STEW_EFFECT_DURATION = builder
                ...
                .defineInRange("mushroom_stew_effect_duration", 5, 0, Integer.MAX_VALUE);
        ...
        RABBIT_STEW_EFFECT_DURATION = builder
                ...
                .defineInRange("rabbit_stew_effect_duration", 10, 0, Integer.MAX_VALUE);
        ...
        BEETROOT_SOUP_EFFECT_DURATION = builder
                ...
                .defineInRange("beetroot_soup_effect_duration", 30, 0, Integer.MAX_VALUE);
        ...
        COOKIE_EFFECT_DURATION = builder
                ...
                .defineInRange("cookie_effect_duration", 5, 0, Integer.MAX_VALUE);
        ...
        PUMPKIN_PIE_EFFECT_DURATION = builder
                ...
                .defineInRange("pumpkin_pie_effect_duration", 15, 0, Integer.MAX_VALUE);
